...
if __name__ == "__main__":
    ...
    window.geometry('365x300')
    window.configure(bg='black')

    display = StringVar()
    display_field = Entry(window, textvariable=display, bg='grey')
    display_field.grid(columnspan=5, ipadx=100)
    display.set('|')
